...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 47.0, 441.0, 549.0, 33.0 ],
									"text" : "Interact contemporarly with both Wekinator and rapidmax: they share the same input, while their respective output is shown separately (based on the same FM synthesizer as in the first example). "
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 127.896040200378422, 491.9732754751019, 100.516748443245888, 87.976076290011406 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_invisible" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 127.896040200378422, 320.582597841552399, 100.516748443245888, 87.976076290011406 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_invisible" : 1,
